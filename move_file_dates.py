...
# Solicitar el directorio de destino al usuario
destination_directory = input("Ingrese el directorio de destino: ")

# Buscar fechas en los archivos del directorio actual
results, files_to_move = search_dates_in_files(year)
...
if results:
    ...
    # Mover archivos encontrados al directorio de destino
