...
After clipping new article URLs or manually correcting original publication
dates, run `utils/reorganize_posts_by_date.py` to apply the folder rule above,
then rebuild the intranet indexes.
...
4. Reorganize post folders using the effective date rule:
